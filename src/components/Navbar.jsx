  ...
  return (
    <nav className='navbar' ref={container}>
        ...
        <ul className='sidebar' style={{display: side}}>
          ...
          <li><Link to="home" smooth={true} duration={500} style={{cursor: 'pointer'}} spy={true}>Home</Link></li>
          <li><Link to="projects" smooth={true} duration={500} style={{cursor: 'pointer'}} spy={true}>Projects</Link></li>
          <li><Link to="experience" smooth={true} duration={500} style={{cursor: 'pointer'}} spy={true}>Experience</Link></li>
          <li><Link to="contact" smooth={true} duration={500} style={{cursor: 'pointer'}} spy={true}>Contact</Link></li>
        </ul>
    </nav>
  )
}
